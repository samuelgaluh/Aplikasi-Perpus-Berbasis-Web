...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Apr 2023 pada 17.14
...
(5, '<i class=\'fa fa-exchange\'></i> #Muhammad Jafar Telah meminjam Buku', 'Admin', 'Belum dibaca'),
(6, '<i class=\'fa fa-repeat\'></i> #Muhammad Jafar Telah mengembalikan Buku', 'Admin', 'Belum dibaca');
...
(3, 'Samuel Galuh Dias Pramudya', 'Home Sweet Loan', '08-04-2023', '08-04-2023', 'Baik', 'Hilang', 'Rp 50.000'),
...
(6, 'Muhammad Jafar', 'Heartbreak Motel', '10-04-2023', '', 'Baik', '', '');
...
(1, '-', '-', 'Admin Cihuy\r\n', 'admin', 'admin', '-', 'Jl.Mawar', 'Iya', 'Admin', '', '15-04-2023 ( 22:00:39 )'),
(3, 'AP002', '6789', 'Muhammad Jafar', 'jafar', 'jafar', 'S1 Sistem Informasi', 'Jl. Kenanga', 'Tidak', 'Anggota', '08-04-2023', '15-04-2023 ( 22:00:16 )');
...
--
ALTER TABLE `pemberitahuan`
  MODIFY `id_pemberitahuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
